const VimeoPlayer = {
	...
	setupEventListeners : function() {
		this._froogaloop.addEvent('loadProgress', function(data) {
			onLoadProgress(data);
		});

		this._froogaloop.addEvent('playProgress', function(data) {
			onPlayProgress(data);
		});

		this._froogaloop.addEvent('play', function(data) {
			onPlay(data);
		});

		this._froogaloop.addEvent('pause', function(data) {
			onPause(data);
		});

		this._froogaloop.addEvent('finish', function(data) {
			onFinish(data);
		});

		this._froogaloop.addEvent('seek', function(data) {
			onSeek(data);
		});
